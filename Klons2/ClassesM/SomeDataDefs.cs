...
using KlonsMDataSet = KlonsF.DataSets.KlonsMDataSet;
...
namespace KlonsM.Classes
{
    ...
    */
    ...
    public class SomeDataDefs
    {
        ...
        public static string GetAcc21(KlonsMDataSet.M_DOCSRow dr_doc)
        {
        ...
        public static string GetAcc231(KlonsMDataSet.M_DOCSRow dr_doc)
        {
        ...
        public static string GetAcc531(KlonsMDataSet.M_DOCSRow dr_doc)
        {
            if (IsStorePartner(dr_doc.XStoreInType))
        ...
        public static bool IsCreditDocInTheSameMonth(KlonsMDataSet.M_DOCSRow dr_doc)
        {
        ...
        public static string GetAccT(KlonsMDataSet.M_ROWSRow dr_row,
