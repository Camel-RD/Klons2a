...
namespace KlonsA.Classes
{
    ...
    public class SalarySheetRowInfo
    {
        ...
        {
            var dr_amats = MyData.DataSetKlonsA.POSITIONS.FindByID(idam);
        ...
        public string GetPositionTitle()
        {
            ...
            var dr_amats = MyData.DataSetKlonsA.POSITIONS.FindByID(Row.IDAM);
            if (dr_amats == null) return null;
            return dr_amats.TITLE;
        }
        ...
        public KlonsADataSet.SALARY_SHEETS_RRow GetTotalRow()
        {
            ...
            return MyData.DataSetKlonsA.SALARY_SHEETS_R.FindByID(Row.IDSX);
        }
        ...
        {
            var table_algas_papildsummas = MyData.DataSetKlonsA.SALARY_PLUSMINUS;
            var dt1 = SalarySheet.MDT1;
            var dt2 = SalarySheet.MDT2;
