...
namespace KlonsP.Classes
{
    public class EventRepInfo : EventInfo, IComparable<EventRepInfo>, IComparable
    {
        ...
        {
            SCat1 = MyData.DataSetKlonsP.CAT1.FindByID(Cat1).CODE;
            SCatD = MyData.DataSetKlonsP.CATD.FindByID(CatD).CODE;
            SCatT = MyData.DataSetKlonsP.CATT.FindByID(CatT).CODE;
            SDepartment = MyData.DataSetKlonsP.DEPARTMENTS.FindByID(Department).CODE;
            SPlace = MyData.DataSetKlonsP.PLACES.FindByID(Place).CODE;
        }
        ...
        public string GetDescr(int k)
        {
            switch (k)
            {
                case 0: return MyData.DataSetKlonsP.CAT1.FindByID(Cat1).DESCR;
                case 1: return MyData.DataSetKlonsP.CATD.FindByID(CatD).DESCR;
                case 2: return MyData.DataSetKlonsP.CATT.FindByID(CatT).DESCR;
                case 3: return MyData.DataSetKlonsP.DEPARTMENTS.FindByID(Department).DESCR;
                case 4: return MyData.DataSetKlonsP.PLACES.FindByID(Place).DESCR;
            }
            return null;
        }
