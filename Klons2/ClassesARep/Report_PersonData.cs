...
namespace KlonsA.Classes
{
    public class Report_PersonData
    {
        ...
        public void ShowReport(int idp, DateTime dt)
        {
            ...
            var table_persons_r = MyData.DataSetKlonsA.PERSONS_R;
            var table_positions = MyData.DataSetKlonsA.POSITIONS;
            var table_positions_r = MyData.DataSetKlonsA.POSITIONS_R;
    ...
    public class RepRowPerson
    {
        ...
        {
            var dr = KlonsData.St.DataSetKlonsA.BANKS.FindByID(id);
            if (dr == null) return;
            BANK_SID = dr.SID;
            BANK_NAME = dr.NAME;
        }
        ...
        public List<KeyValuePair<DateTime, CalcRRow2>> GetDatesAndRates(DateTime dte)
        {
            ...
            var table_rates = MyData.DataSetKlonsA.RATES;
            var table_untaxedmin = MyData.DataSetKlonsA.UNTAXED_MIN;
    ...
    public class RepRowPosition
    {
        ...
        public void SetFromPositionDataRow(KlonsADataSet.POSITIONS_RRow dr)
        {
            ...
            IDDEP = dr.IDDEP;
            if (IDDEP != null)
                DEP = MyData.DataSetKlonsA.DEPARTMENTS.FindByID(IDDEP)?.DESCR;
            TITLE = dr.TITLE;
            ...
            if (OCCUPATION_CODE != null)
                OCCUPATION_CODE_S = MyData.DataSetKlonsA.PROFESSIONS.FindByID(OCCUPATION_CODE)?.DESCR;
            USED = dr.USED;
            EDIT_DATE = dr.EDIT_DATE;
        ...
        public void GetRatesHistory()
        {
            ...
            var dr_pos = MyData.DataSetKlonsA.POSITIONS.FindByID(ID);
    ...
    public class RepRowEvent
    {
        ...
        public void SetFromDataRow(KlonsADataSet.EVENTSRow dr)
        {
            ...
            EventName = MyData.DataSetKlonsA.EVENT_TYPES.FindByID(IDN)?.DESCR;
            if (IDN2 != null)
                Event2Name = MyData.DataSetKlonsA.EVENT_TYPES.FindByID(IDN2.Value)?.DESCR;
        }
