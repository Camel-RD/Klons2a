...
namespace KlonsA.Forms
{
    public partial class FormA_SalarySheets : MyFormBaseF
    {
        ...
        {
            var table_algu_lapas = MyData.DataSetKlonsA.SALARY_SHEETS;
        ...
        public void OpenCurrent()
        {
            ...
            var f = MyMainForm.FindForm(typeof(FormA_SalarySheet)) as FormA_SalarySheet;
            if (f == null)
                f = MyMainForm.ShowForm(typeof(FormA_SalarySheet)) as FormA_SalarySheet;
            f.Activate();
            f.SelectSheet(dr.ID);
        }
        ...
        {
            if (MyMainForm.FindForm(typeof(FormA_SalarySheet)) != null)
            {
