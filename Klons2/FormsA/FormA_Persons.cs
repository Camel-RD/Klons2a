...
namespace KlonsA.Forms
{
    public partial class FormA_Persons : MyFormBaseF
    {
        ...
        private void PersonsOnPersonsRowChanged(object sender, KlonsADataSet.PERSONSRowChangeEvent e)
        {
            ...
            {
                var tablePersonsR = MyData.DataSetKlonsA.PERSONS_R;
        ...
        private void AmatiOnAmatiRowChanged(object sender, KlonsADataSet.POSITIONSRowChangeEvent e)
        {
            if (e.Action == DataRowAction.Add)
            {
                var tableAmatR = MyData.DataSetKlonsA.POSITIONS_R;
        ...
        public void DropChanges()
        {
            ...
            {
                var table = MyData.DataSetKlonsA.Tables[tablename];
                try
                {
                    table.RejectChanges();
                }
        ...
        {
            var am = MyAdapterManager1.GetAdapterManager() as KlonsF.DataSets.KlonsADataSetTableAdapters.TableAdapterManager;
            am.UpdateAll(MyData.DataSetKlonsA);
        }
    }
}
