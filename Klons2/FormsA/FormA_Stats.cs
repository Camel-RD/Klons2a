...
namespace KlonsA.Forms
{
    public partial class FormA_Stats : MyFormBaseF
    {
        ...
        {
            var ad = new KlonsF.DataSets.KlonsARepDataSetTableAdapters.SP_STATS_01TableAdapter();
            var ad2 = new KlonsF.DataSets.KlonsARepDataSetTableAdapters.SP_STATS_02TableAdapter();
