...
namespace KlonsA.Forms
{
    public partial class FormA_Rates : MyFormBaseF
    {
        ...
        private void bindingNavigatorAddNewItem_Click(object sender, EventArgs e)
        {
            ...
            //newdr.ID = (int)MyData.KlonsAQueriesTableAdapter.SP_RATES_ID();
            newdr.ID = MyData.DataSetKlonsA.RATES.Max(d => d.ID) + 1;
            newdr.EndEdit();
        ...
        private void bsLikmes_MyBeforeRowInsert(MyRowUpdateEventArgs e)
        {
            ...
            if (dr == null) return;
            dr.ID = (int)MyData.KlonsAQueriesTableAdapter.SP_RATES_ID();
        }
        */
