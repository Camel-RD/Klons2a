...
namespace KlonsA.Forms
{
    public partial class FormA_PayListsTempl : MyFormBaseF
    {
        ...
        {
            MyData.DataSetKlonsA.PAYLIST_TEMPL_R.ColumnChanged += PAYLIST_TEMPL_R_ColumnChanged;
            CheckEnableGrid();
            CheckSave();
        }
        ...
        {
            if(e.Column == MyData.DataSetKlonsA.PAYLIST_TEMPL_R.IDPColumn)
            {
        ...
        private void SelectCurrent()
        {
            ...
            var dr = bsShL.CurrentDataRow as KlonsF.DataSets.KlonsADataSet.PAYLIST_TEMPLRow;
        ...
        {
            SetControlEnabled(dgvShR, !(dgvShL.CurrentRow == null || 
