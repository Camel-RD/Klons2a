...
namespace KlonsA.Forms
{
    public partial class FormA_PayLists : MyFormBaseF
    {
        ...
        private void Form_PayLists_Load(object sender, EventArgs e)
        {
            ...
            MyData.DataSetKlonsA.PAYLISTS_R.ColumnChanged += PAYLISTS_R_ColumnChanged;
            MyData.DataSetKlonsA.PAYLISTS_R.PAYLISTS_RRowChanged += PAYLISTS_R_PAYLISTS_RRowChanged;
            MyData.DataSetKlonsA.PAYLISTS_R.PAYLISTS_RRowDeleted += PAYLISTS_R_PAYLISTS_RRowDeleted;
            MyData.DataSetKlonsA.PAYLISTS_R.PAYLISTS_RRowDeleting += PAYLISTS_R_PAYLISTS_RRowDeleting;
            MyData.DataSetKlonsA.PAYLISTS.ColumnChanged += PAYLISTS_ColumnChanged;
            CheckEnableRows();
            CheckEnableSGR();
            CheckSave();
        }
        ...
        {
            if (e.Column == MyData.DataSetKlonsA.PAYLISTS.DTColumn)
            {
        ...
        {
            var table = MyData.DataSetKlonsA.PAYLISTS_R;
            if (e.Column == table.IDPColumn)
            {
                if (e.ProposedValue == null || e.ProposedValue == DBNull.Value) return;
                int idp = (int)e.ProposedValue;
                var drp = MyData.DataSetKlonsA.PERSONS.FindByID(idp);
                e.Row.BeginEdit();
        ...
        public void UpdateListMatch(KlonsADataSet.PAYLISTS_RRow dr)
        {
            ...
            */
                ...
                var ad2 = new KlonsF.DataSets.KlonsARepDataSetTableAdapters.SP_PAY_MATCHLISTS_1XTableAdapter();
        ...
        {
            var table_paylists = MyData.DataSetKlonsA.PAYLISTS;
        ...
        {
            if (MyData.DataSetKlonsA.PAYLIST_TEMPL.Count == 0)
            {
        ...
        public void RecalcAskWhat()
        {
            ...
            bool rt = FormA_PayListsRecalcParams.ShowDialog(out var datefrom, out var idp);
            if (!rt) return;
