...
namespace KlonsA.Forms
{
    public partial class FormA_SalarySheetTempl : MyFormBaseF
    {
        ...
        {
            MyData.DataSetKlonsA.SALARY_SHEET_TEMPL_R.ColumnChanged += SALARY_SHEET_TEMPL_R_ColumnChanged;
        ...
        {
            if(e.Column == MyData.DataSetKlonsA.SALARY_SHEET_TEMPL_R.IDPColumn)
            {
