...
namespace KlonsA.Forms
{
    public partial class FormA_PieceWork : MyFormBaseF
    {
        ...
        private void PIECEWORK_ColumnChanged(object sender, DataColumnChangeEventArgs e)
        {
            ...
            if(e.Column == MyData.DataSetKlonsA.PIECEWORK.IDKColumn)
            {
                var drk = MyData.DataSetKlonsA.PIECEWORK_CATALOG.FindByID(dr.IDK);
                if (drk == null) return;
                //dr.DESCR = drk.DESCR;
                dr.UNIT = drk.UNIT;
                dr.RATE = drk.RATE;
            ...
            if (e.Column == MyData.DataSetKlonsA.PIECEWORK.IDAColumn)
            {
            ...
            if (e.Column == MyData.DataSetKlonsA.PIECEWORK.QUANTITYColumn ||
                e.Column == MyData.DataSetKlonsA.PIECEWORK.RATEColumn ||
                e.Column == MyData.DataSetKlonsA.PIECEWORK.BONUSColumn)
            {
            ...
            if (e.Column == MyData.DataSetKlonsA.PIECEWORK.QUANTITYColumn ||
                e.Column == MyData.DataSetKlonsA.PIECEWORK.TIMEUNITColumn ||
                e.Column == MyData.DataSetKlonsA.PIECEWORK.TIMEUSEColumn)
            {
                float tm = dr.TIMEUSE;
