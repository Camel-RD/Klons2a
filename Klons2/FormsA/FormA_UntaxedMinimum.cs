...
namespace KlonsA.Forms
{
    public partial class FormA_UntaxedMinimum : MyFormBaseF
    {
        ...
        {
            var table = MyData.DataSetKlonsA.UNTAXED_MIN;
        ...
        {
            var dr = e.DataRow as KlonsF.DataSets.KlonsADataSet.UNTAXED_MINRow;
            dr.ID = (int)MyData.KlonsAQueriesTableAdapter.SP_A_GEN_UNTAXED_MIN_ID();
        }
        ...
        {
            if (!SaveData()) return;
            var form = MyMainForm.ShowFormDialog(typeof(FormA_UntaxedMinimumImport)) as FormA_UntaxedMinimumImport;
        }
    }
}
