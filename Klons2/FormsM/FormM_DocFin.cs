...
namespace KlonsM.FormsM
{
    public partial class FormM_DocFin : MyFormBaseF
    {
        ...
        public string TestAccFin(string[] accs)
        {
            ...
            {
                var table_accplan = MyData.DataSetKlonsF.AcP21;
        ...
        public string TestAccPVN(string[] accs)
        {
            ...
            foreach (var acc in accs)
            {
                var table_accplan = MyData.DataSetKlonsF.Acp25;
        ...
        public string TestPartnerCode(int iddoc)
        {
            ...
            if (MyData.DataSetKlonsF.Persons.FindByClId(clid) == null)
        ...
        public string TestDocTypeCode(int iddoc)
        {
            ...
            var table = MyData.DataSetKlonsF.DocTyp;
        ...
        public void DoAccountingA(int iddoc)
        {
            ...
            dr_fdoc.id = (int)MyData.KlonsFQueriesTableAdapter.SP_OPSD_ID();
            dr_fdoc.Dete = dr_doc.DT;
            dr_fdoc.ZNR = (int)MyData.KlonsFQueriesTableAdapter.SP_OPSD_GETNEXTNRFORYEARA(dr_fdoc.Dete.Year);
            ...
            foreach(var accdata in DocAccRepRows)
            {
                ...
                dr_frow.id = (int)MyData.KlonsFQueriesTableAdapter.SP_OPS_ID();
