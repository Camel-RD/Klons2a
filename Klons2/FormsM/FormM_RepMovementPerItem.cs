...
namespace KlonsM.FormsM
{
    public partial class FormM_RepMovementPerItem : MyFormBaseF
    {
        ...
        public void MakeReport()
        {
            ...
            var ad = new KlonsF.DataSets.KlonsMRepDataSetTableAdapters.SP_M_REP_ITEMSAMOUNTS_3TableAdapter();
        ...
        {
            var idcat = FormM_ItemsCat.GetItemsCatId(tbCatCode.Text);
            if (!idcat.HasValue) return;
            tbCatCode.SelectedValue = idcat.Value;
        }
