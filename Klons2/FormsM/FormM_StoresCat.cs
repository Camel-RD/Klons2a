...
namespace KlonsM.FormsM
{
    public partial class FormM_StoresCat : MyFormBaseF
    {
        ...
        public static string GetStoresCatCode(string code)
        {
        ...
        public static int? GetStoresCatId()
        {
            var fm = new FormM_StoresCat();
            var ret = fm.ShowMyDialogModal();
            if (ret != DialogResult.OK) return null;
        ...
        private void SelectCurrent()
        {
            ...
            var dr = bsRows.CurrentDataRow as KlonsMDataSet.M_STORES_CATRow;
        ...
        private bool IsRow0(int rownr)
        {
            ...
            var dr = dgvRows.GetDataRow(rownr) as KlonsMDataSet.M_STORES_CATRow;
