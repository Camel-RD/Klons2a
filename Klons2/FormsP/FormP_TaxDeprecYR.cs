...
namespace KlonsP.Forms
{
    public partial class FormP_TaxDeprecYR : MyFormBaseF
    {
        ...
        {
            yr1 = yr2 = 0;
            var table = MyData.DataSetKlonsP.TAXDEPRECYEAR;
        ...
        {
            int yr = 0;
            if (MyData.DataSetKlonsP.ITEMS.WhereNotDeleted().Count() == 0)
            {
            ...
            if (MyData.DataSetKlonsP.TAXDEPRECYEAR.WhereX(d => d.YR == yr).Count() > 0)
            {
        ...
        public List<TaxDeprecCalcInfo> CalcYear(int yr, bool addstartvalues)
        {
            ...
            var table_deprec = MyData.DataSetKlonsP.TAXDEPRECYEAR;
            var table_catt = MyData.DataSetKlonsP.CATT;
