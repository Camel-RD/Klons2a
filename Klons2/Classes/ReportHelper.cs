...
namespace KlonsF.Classes
{
    ...
    {
        public klonsRepDataSet MyDataSet { get { return KlonsData.St.DataSetKlonsFRep; } }

        public override bool CheckForErrors(Action act)
        {
            var t1 = KlonsData.St.DataSetKlonsF.OPSd.GetChanges();
            var t2 = KlonsData.St.DataSetKlonsF.OPS.GetChanges();
        ...
        {
            ROps2aTableAdapter ad2a = KlonsData.St.GetKlonsFRepAdapter("ROps2a") as ROps2aTableAdapter;
        ...
        {
            foreach (var dr in KlonsData.St.DataSetKlonsF.BalA22)
            {
                if (dr.balid != balid) continue;
                var dr2 = KlonsData.St.DataSetKlonsF.BalA21.FindByid(dr.id);
                if (dr2 == null)
                {
                    dr.S1 = 0.00M;
                    dr.S2 = 0.00M;
            ...
            KlonsData.St.DataSetKlonsF.BalA22.AcceptChanges();
        }
